...
│   └── web_scraper.py        # Example scraper script
│
...
*   **`scraper/web_scraper.py`**: (Optional) Contains the script(s) used to originally collect the data that forms the knowledge base.
